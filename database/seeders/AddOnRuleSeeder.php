...
class AddOnRuleSeeder extends Seeder
{
    ...
    {
        AddonRule::create([
                'begin_date'                =>  '2023-12-01 00:00:00','end_date' => '2023-12-07 00:00:00',
                'baseprice'                 =>  8,
                ...
                'rule_11_name'              =>  'Cancelations when courier is in P/U','rule_11_value'    =>  0,
                'rule_12_name'              =>  'Cancelations when courier is in DROP','rule_12_value'    =>  0,
